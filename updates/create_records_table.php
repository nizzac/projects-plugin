...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('ncarps_projects_records', function(Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('id');
            ...
            $table->foreign('task_id')->references('id')->on('ncarps_projects_tasks');
    ...
    {
        Schema::dropIfExists('ncarps_projects_records');
    }
};
